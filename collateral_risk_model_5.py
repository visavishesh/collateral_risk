...
for mu in mu_range:
    ...
    for sigma in sigma_range:
        ...
        data_results+=[{"mu":mu,"sigma":sigma,"gain-loss":np.average(result_array)}]
        print(mu,sigma,liquidation_penalty, np.average(result_array))

fig = px.scatter_3d(pd.DataFrame(data_results), x='mu', y='sigma', z='gain-loss',
