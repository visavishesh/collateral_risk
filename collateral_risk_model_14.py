...
def aggregate_results(config):
    ...
    aggregate["jump_probabilities_1"]=jump_probabilities[0]
    aggregate["jump_probabilities_2"]=jump_probabilities[1]
    aggregate["jump_probabilities_3"]=jump_probabilities[2]
...
for config in config_array:
    results = aggregate_results(config)
